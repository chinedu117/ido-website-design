...
const MCH_CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_MCH_CONTRACT_ADDRESS //MCH Token Contract Address
...
export const WalletProvider = ({ children }: WalletProviderProps) => {
  ...
  const fetchBalances = async () => {
    ...
    try {
      ...
      setEthBalance(Number.parseFloat(formattedEthBalance).toFixed(4))

      // Fetch Token balance
      const nairaTokenContract = new ethers.Contract(NAIRA_CONTRACT_ADDRESS, TOKEN_ABI, provider)
      ...
      setNairaTokenBalance(Number.parseFloat(formattedTokenBalance).toFixed(2))

      const mchTokenContract = new ethers.Contract(MCH_CONTRACT_ADDRESS!, TOKEN_ABI, provider)
